...
import { AppBar, Toolbar, IconButton, Card, Button ,Input,Autocomplete} from "@mui/material";
...
export default class Patients extends Component {
 ...
 console.log(index,"🎯🎯🎯")
  ...
  initializeData= async()=>{
    ...
    return {firstName: doc.data().firstName,
    ...
    return (
        ...
        <Container maxWidth="lg" sx={{bgcolor:"#E5E5E5"}} >
          ...
          <Typography
            ...
            color="#0B2B5B"
            gutterBottom
            sx={{ mt: 2, pt: 3, pb: 0, fontSize: 30,fontFamily:"Montserrat" ,fontWeight:
            500}}
          >
            Patients Referrel Form
          </Typography>
          ...
          <this.Alert/>
            ...
            <Typography variant="h6" color="#0B2B5B;" sx={{fontSize:"17px",mb:5}}>
                ...
                <Accordion sx={{mt:1,borderRadius:1}}  defaultExpanded={false} >   
                  ...
                  >
                    <Typography fullWidth
                      sx={{
                        float: "left",
                        backgroundColor: "#25A575;", p:1, width:20,color:"white", mr:3
                       
                      }}
                    >
                      {index+1}
                    </Typography>
                    <Typography  variant="h5" sx={{textAlign:"left",width:700 }} >
                     
                      {fullName}
                    </Typography>
                    <Typography sx={{position:"static"}}> <DeleteIcon onClick={() => this.removeDetails(index)} sx={{float:"right"}}/></Typography>
                  ...
                  <AccordionDetails>
                    <Grid container spacing={3}> 
                      ...
                      <Grid item xs={12} sm={6}>
                        <Input type="Date" sx={{mt:2,color:"gray"}}
                          required
                          id="dob"
                      ...
                      <Grid item xs={12} sm={6}>
                        <TextField 
                          required
                          id="contactLanguage" sx={{color:"gray"}}
                          name="contactLanguage" value={data.contactLanguage??""}
                          onChange={(event) => this.handleChange(event, index)}
                      ...
                      <Grid item xs={12}>
                        ...
                        <Autocomplete  name="address1" value={data.address1??""} sx={{borderTop:"none"}}
                        options={address.map((option) => option.streetAddress)}
                          onChange={(event,value) => this.handleChangeAddress(event,value, index)} // prints the selected value
                          renderInput={params => (
            ...
            <Grid item xs={12} sx={{ mt: 1,mb:5}}>
                <Button variant="text" onClick={this.addPatientData} sx={{color:"#0B2B5B"}}>
                  {" "}
